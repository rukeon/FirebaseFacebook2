...
public class UploadActivity extends AppCompatActivity implements
    ...
    private static final int RC_GALLARY_PICTURE = 103;
...
//        mAuth.getCurrentUser().getDisplayName()
        ...
        // [START get_storage_ref] -> it'll return root dir of firebase storage
        mStorageRef = FirebaseStorage.getInstance().getReference();
        // [END get_storage_ref]

        // Click listeners
        findViewById(R.id.button_camera).setOnClickListener(this);
        findViewById(R.id.button_gallary).setOnClickListener(this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        } else if (requestCode == RC_GALLARY_PICTURE) {
            if (resultCode == RESULT_OK) {
                showProgressDialog();

                Uri uri  = data.getData();
                final StorageReference gallaryRef = mStorageRef.child("photos")
                        .child(uri.getLastPathSegment());
                gallaryRef.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    @Override
                ...
                Toast.makeText(this, "Taking gallary failed.", Toast.LENGTH_SHORT).show();
            }
    ...
    private void launchCamera() {
        ...
        mFileUri = FileProvider.getUriForFile(this,
                "rukeon.com.firebasefacebook.fileprovider", file);
    ...
    private void lauchGallary() {
        Intent getImageFromGallaryintent = new Intent(Intent.ACTION_PICK);

        getImageFromGallaryintent.setType("image/*");

        startActivityForResult(getImageFromGallaryintent, RC_GALLARY_PICTURE);
    }
